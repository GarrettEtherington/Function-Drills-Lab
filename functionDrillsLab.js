...
//CODE HERE
function add (numbor1, numbor2){
  return Number(numbor1) + Number(numbor2)
} 
console.log(add(5, 7))
////////////////// PROBLEM 7 ////////////////////
...
function nameCheck (NAMEPARAM){
  if (NAMEPARAM === `Steven`){
    ...
    console.log(`Bryan is a stupid name`)
  } else {
...
//   NAMEPARAM >= `Steven` ? console.log(`What's up Steven?`) : console.log(`Cool name, ${NAMEPARAM}`)
//   // NAMEPARAM >= `Bryan` ? console.log(`Hey Bryan!`) :
